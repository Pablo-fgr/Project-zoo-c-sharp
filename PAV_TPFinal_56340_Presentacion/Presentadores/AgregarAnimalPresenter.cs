...
public class AgregarAnimalPresenter : PresenterBase<ZoologicoTarea, IAgregarAnimalView>
{
    ...
    public void AgregarAnimal(string nombre, int edad, double peso, Guid idEspecie, Guid idPais, Guid idSector)
    {
        ...
        Pais? paisOrigen = _repositorio.ObtenerPorId<Pais>(idPais);
        Sector? sector = _repositorio.ObtenerPorId<Sector>(idSector);
